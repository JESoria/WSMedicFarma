...
namespace WService.Controllers
{
    public class TicketController : ApiController
    {
        ...
        [HttpPost]
        public IHttpActionResult SendEmail(TicketModel data)
        {
            try
            {
                ...
                Template template = Template.Parse(
                    ...
                    " <p>Graciás por tu compra en {{ user.sucursal }} </p>" +
                    " <p>Información del pedido:</p>" +
                    "----------------------------------------------------------------------------" +
                    " <p>ID PEDIDO: {{user.id_pedido}} </p>" +
                    " <p>CODIGO PAYPAL: {{user.codigo_paypal}}</p>" +
